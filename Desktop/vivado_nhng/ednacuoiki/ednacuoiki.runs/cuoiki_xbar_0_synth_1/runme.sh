...
HD_PWD='C:/Users/S88 Service/Desktop/vivado_nhng/ednacuoiki/ednacuoiki.runs/cuoiki_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cuoiki_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cuoiki_xbar_0.tcl
