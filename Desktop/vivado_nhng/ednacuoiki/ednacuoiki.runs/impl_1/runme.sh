...
HD_PWD='C:/Users/S88 Service/Desktop/vivado_nhng/ednacuoiki/ednacuoiki.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cuoiki_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cuoiki_wrapper.tcl -notrace
