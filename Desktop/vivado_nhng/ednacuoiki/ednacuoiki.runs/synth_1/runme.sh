...
HD_PWD='C:/Users/S88 Service/Desktop/vivado_nhng/ednacuoiki/ednacuoiki.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cuoiki_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cuoiki_wrapper.tcl
