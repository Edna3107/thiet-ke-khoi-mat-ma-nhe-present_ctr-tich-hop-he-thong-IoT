...
-- Date        : Wed Dec 31 09:45:04 2025
-- Host        : edna running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ cuoiki_present_ctr_0_3_sim_netlist.vhdl
-- Design      : cuoiki_present_ctr_0_3
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_present is
  ...
  attribute SOFT_HLUTNM of \ciphertext[63]_i_1\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of pres_start_i_1 : label is "soft_lutpair2";
...
pres_start_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DC1C"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_present_ctr is
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "load:01,run:10,idle:00,finish:11";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "load:01,run:10,idle:00,finish:11";
...
pvalid_i_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
u_present: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_present
     port map (
      ...
      done_reg_reg_0 => u_present_n_0,
      done_reg_reg_1 => u_present_n_2,
      ...
      kvalid_i => kvalid_i,
      pres_start_reg => pres_start_reg_n_0,
...
u_ctr: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_present_ctr
     port map (
      \FSM_sequential_state_reg[0]_0\ => \r_ctrl_reg_n_0_[0]\,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "cuoiki_present_ctr_0_3,present_ctr_v1_0,{}";
